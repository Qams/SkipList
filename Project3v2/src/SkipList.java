...
public class SkipList<K extends Comparable<K>, V> implements Iterable<SkipList<K,V>.Node<K,V>> {
	...
	public static void main(String[] args) {
		...
		long start, stop;
		ConcurrentSkipListMap<Integer, Integer> cskl = new ConcurrentSkipListMap<>();
		...
		for (int i = 0; i < 100000; i++) {
			sl.put((Integer) list.get(i), i);
		}
		stop = System.currentTimeMillis();
		System.out.println(stop - start);
		start = System.currentTimeMillis();
		for (int i = 0; i < 100000; i++) {
			cskl.put((Integer) list.get(i), i);
		}
		stop = System.currentTimeMillis();
		System.out.println(stop - start);
		...
		System.out.println("Levels: " + sl.levels);
		...
		stop = System.currentTimeMillis();
		System.out.println(stop - start);
		System.out.println("Po wyczyszczeniu i dodaniu przykladowych elementow: ");
		sl.put(12, 22);
		sl.put(19, 29);
		sl.put(15, 35);
		sl.put(14, 34);
		sl.put(19, 29);
		sl.print();
		for(SkipList<Integer,Integer>.Node<Integer, Integer> it : sl)
		{
